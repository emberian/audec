...
| Beat This! small0 | `CPJKU/beat_this@b95c8ab0c58c2d9fcfd4058aa8dffbc05ac4f5c`; `small0.ckpt` SHA-256 `6074be2c4d490c5f6101fcc374a1ec72ae93456e23bb6019783b849f5dc7d47b` | pinned Python/torch CPU worker, 22.05 kHz mono; MPS only after an Audec golden | MIT code/weights; training set contains copyrighted and limited-CC material, so opt-in and `RequiresReview` |
